    ...
    <footer className="bg-green-950 text-white py-12">
      <div className="container max-w-7xl px-4 mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* Rabaul Hotel */}
          <div>
            <h3 className="text-2xl font-bold mb-4">Rabaul Hotel</h3>
            <p className="text-gray-300 mb-4">
              Experience luxury and comfort at Rabaul Hotel, where the road ends and the adventure begins!
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/#rooms" className="text-gray-300 hover:text-white transition-colors">Rooms & Suites</Link></li>
              <li><Link href="/#dining" className="text-gray-300 hover:text-white transition-colors">Dining</Link></li>
              <li><Link href="/#explore" className="text-gray-300 hover:text-white transition-colors">Explore Rabaul</Link></li>
          ...
          <div>
            ...
            <address className="not-italic">
              <p className="text-gray-300 mb-2">123 Main Street, Rabaul, Papua New Guinea</p>
              <p className="text-gray-300 mb-2">
                <a href="tel:+67512345678" className="hover:text-white transition-colors">+675 1234 5678</a>
              </p>
              <p className="text-gray-300">
                <a href="mailto:info@rabaulhotel.com" className="hover:text-white transition-colors">info@rabaulhotel.com</a>
              </p>
            </address>
          </div>
          ...
          <div>
            ...
            <form className="flex">
              ...
              <button
                type="submit"
                className="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-r-md transition-colors focus:outline-none focus:ring-2 focus:ring-green-500"
              >
                Subscribe
              </button>
            </form>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-400 text-sm">
          <p>&copy; {new Date().getFullYear()} Rabaul Hotel. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
